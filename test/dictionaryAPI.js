...
// document.querySelector('.search-definition').addEventListener('click', fetchApi)
...
//       console.log(data)
//       document.querySelector('.definition').innerText = definitions.definition;
//       }
//       .catch(err => {
//           console.log(`error ${err}`)
//       });
...
function data(result, word) {
  ...
  if (result.title) { // if api returns the message of can't find word
      ...
      if (definitions.synonym == undefined) { // if there are no synonyms, then hide the div
